...
$sql1 = "UPDATE `chartofaccounts` SET `Accounts_Name`='$account_name',`HeadOfAccounts_Id`='$account_type',`BalanceType_Id`='$balance_type',`Description`='$description' WHERE `Accounts_Id`='$id_new' ";
$result = mysqli_query($conn,$sql1);
		echo "<script>
...
/*
	else
	{
		...
		$sql = "INSERT INTO `chartofaccounts`(`Accounts_Id`, `Accounts_Name`, `HeadOfAccounts_Id`, `BalanceType_Id`, `EntryTypeId`, `Amount`, `Description`) VALUES ($new_id+1,'$account_name','$account_type','$balance_type','$entry_type','$amount','$description') ";
