...
function showUser(str) {
  ...
  xmlhttp.open("GET","state_table.php?q="+str,true);
  xmlhttp.send();
}
</script>
  <script>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">State Information</li>
      </ol><br>
...
<a  href="dashboard.php" class="btn btn-large btn-primary" style="float: left;"><i class="fa fa-arrow-left fa-large"></i> Back</a>
      ...
      <div class="card mb-3" style="width:300px; float: left; margin-left: 40px;">
        <div class="card-header" align="center">
          <i class="fa fa-plus"></i> Add State Information</div>
        <div class="card-body">
          <form action="save_state_info.php" method="post">
            ...
            <input type="text" class="form-control" style="width: 200px;" name="txt_StateName" placeholder="State Name" required>
            <br>
            <br>
            <div align="center">
      ...
      <div class="card mb-3" style="width:600px; float: right; margin-right: 30px;">
        <div class="card-header" align="center">
          <i class="fa fa-list"></i> State Information</div>
        <div class="card-body">
