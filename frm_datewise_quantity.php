...
<head>
  ...
  <title>Date-Wise Quantity List</title>
<style type="text/css">
  hr {
    color: black;
    ...
    <div class="container-fluid">
      ...
      <div align="center">
        ...
        <label>Select Product:</label>
          ...
          <h5 align="center"> Product Stock Date-Wise </h5>
          <br>
          ...
          <br>
            ...
            <tbody>
              <?php
                    ...
                    $sql1 = "SELECT *,date_format(Product_Stock_Date, '%d-%m-%Y') AS Product_Stock_Date FROM Product_Master AS PM, Product_Stock AS PS, vendor as V WHERE PM.Barcode_ID = PS.Barcode_ID AND PS.Barcode_ID = $barcode_ID AND PS.Vendor_ID=V.Vendor_ID ORDER BY Product_Stock_ID DESC";
                  ...
                  <tr align="center">
                    <td><?php echo $i+1 ?></td>
                  <td><?php echo $row1['Product_Stock_Date'] ;?></td>
            ...
            <table align="center" width="60%" style="line-height:40px;" cellspacing="0" border= "1">
              <tbody>
                <?php 
                $sql3 = "SELECT SUM(Product_Quantity) AS Product_Quantity FROM Product_Stock WHERE Barcode_ID = $barcode_ID";
