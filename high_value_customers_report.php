...
<head>
  ...
  <title>Highest Value Customers Report</title>
<style type="text/css">
  hr {
    color: black;
  ...
  die('Could not connect: ' . mysqli_error($con));
      ...
      <div align="center">
        <form action="#" method="Post">
          ...
          <br>
          <h5>Highest Value Customers Report</h5>
          <br>
...
if (!$con) {
  die('Could not connect: ' . mysqli_error($con));
              ...
              $sql2 = "SELECT * FROM customer AS C, gender AS G WHERE C.Gender_ID = G.Gender_ID ORDER BY Total_Spent DESC";
             // print_r($sql4);
              //exit();
