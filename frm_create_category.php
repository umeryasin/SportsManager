...
<span style="font-size: 22px;"><img src="images/create_category.png" style="width: 50px; height: 50px;"> Create Category</span>  
</div>
<br>
      <!-- Example DataTables Card-->
      <div class="card mb-3"  style="width: 100%;">
        <div class="card-header" align="">
          <i class="fa fa-tags"></i> Create Category</div>
          ...
          <div class="row">
              ...
              <form method="post" action="create_category.php">
                ...
                <div class="row">
                  <div class="offset-4 col-md-4">
                    <input type="submit" name="create_cate" class="btn" value="Create">
                  </div>
                </div>
              </form>
            </div>
            <div class="col-md-5">
              <table class="table table-bordered table-hover" id="dataTable">
                ...
                <tbody>
                  <?php
                  $sql_get_cat="SELECT * FROM productcategory";
                  $run_get_cat=mysqli_query($ob->connect(),$sql_get_cat);
                  while($row_get_cat=mysqli_fetch_assoc($run_get_cat))
                  {
                    ?>
                    <tr>
                      <td><?php echo $row_get_cat['Category_Name']; ?></td>
                      <td>
                        <a href="create_category_del.php?id=<?php echo $row_get_cat['Product_Category_ID']; ?>" class="btn btn-danger"><i class="fa fa-trash"> Delete</i></a>
                      </td>
                    </tr>
                    <?php
                  }
