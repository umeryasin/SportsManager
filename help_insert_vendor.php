        ...
        <div class="card-body">
          <div style="width: 35%; float: left;">
            ...
            <div class="list-group">
              ...
              <a href="help_insert_vendor.php" class="list-group-item active">How to insert vendors info</a>
          ...
          <div style="margin-left: 460px;">
            <ul>
              <li>Click on vendors and click on add new vendor</li>
              <li>
                <img src="images/add_vend.png" width="100%" >
                <li>Fill out forms and so on...</li>
            </ul>
          </div>
        </div>
      </div>
