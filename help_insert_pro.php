        ...
        <div class="card-body">
          <div style="width: 35%; float: left;">
            ...
            <div class="list-group">
              <a href="help_insert_pro.php" class="list-group-item active">How to insert product in Fabric Manger</a>
          ...
          <div style="margin-left: 460px;">
            <ul>
              <li>First of all click on add new product</li>
              <li>
                <img src="images/add_new_pro.png" width="100%" >
              </li>
              <li>Fill The Form include barcode, name,.</li>
              <li><img src="images/fill_form.png" width="100%" ></li>
              <li>To save click on save</li>
              <li><img src="images/save_pro.png" width="100%" ></li>
              <li>Click cancel if you dont't want to</li>
            </ul>
          </div>
        </div>
      </div>
