    ...
    <div class="container-fluid">
      ...
      <div align="center">
        <form action="#" method="Post">
          ...
          <br>
            <div id="view">
            <table width="90%" style="line-height:40px;" cellspacing="0" border= "0">
              <thead>
              ...
              <?php
              $sql2 = "SELECT * FROM product_master AS PM, productcategory AS PC WHERE PM.Product_Category_ID = PC.Product_Category_ID AND PM.Barcode_ID > 0";
             // print_r($sql4);
              //exit();
             ...
             // print_r($sql4);
              ...
              ///
                ...
                $sql5 = "SELECT * FROM Product_Price WHERE Barcode_ID = $Barcode_ID ORDER BY Product_Price_ID DESC LIMIT 1" ;
             // print_r($sql4);
              //exit();
      ...
      <tr>
        ...
        <td><?php echo $row4['Purchase_Price']; ?> Rs</td>
        <td><?php echo $row4['Retail_Price']; ?> Rs</td>
        <td><?php echo $row4['Product_Discount']; ?>%</td>
