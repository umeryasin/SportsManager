...
<head>
  ...
  <title>Create Product Color</title>
...
<span style="font-size: 22px;"><img src="images/color-palette.svg" style="width: 50px; height: 50px;"> Create Product Color</span>  
</div>
<br>
      <!-- Example DataTables Card-->
      <div class="card mb-3"  style="width: 100%;">
        <div class="card-header" align="">
          <i class="fa fa-tags"></i> Create Products Colors</div>
        <div class="card-body" align="center">
          <div class="row">
            <div class="col-md-7">
              <form method="post" action="create_color.php">
                <div class="row">
                  <div class="col-md-4">
                    <p>Color Name</p>
                  </div>
                ...
                <div class="row">
                  <div class="offset-4 col-md-4">
                    <input type="submit" name="create_color" class="btn" value="Create">
                  </div>
                </div>
              </form>
            </div>
            <div class="col-md-5">
              <table class="table table-bordered table-hover" id="dataTable">
                ...
                <tbody>
                  <?php
                  $sql_get_cat="SELECT * FROM product_color";
                  $run_get_cat=mysqli_query($ob->connect(),$sql_get_cat);
                  while($row_get_cat=mysqli_fetch_assoc($run_get_cat))
                  {
                    ?>
                    <tr>
                      <td><?php echo $row_get_cat['pro_color_name']; ?></td>
                      <td>
                        <a href="create_color_del.php?id=<?php echo $row_get_cat['pro_color_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"> Delete</i></a>
                      </td>
                    </tr>
                    <?php
                  }
