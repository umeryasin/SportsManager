        ...
        <div class="card-body">
          <div style="width: 35%; float: left;">
            ...
            <div class="list-group">
              ...
              <a href="help_edit_pro.php" class="list-group-item">How to edit saved product</a>
              <a href="help_insert_customer.php" class="list-group-item active">How to insert customers info</a>
          ...
          <div style="margin-left: 460px;">
            <ul>
              <li>Click on customer icon and click on add new product</li>
              <li>
                <img src="images/insert_customer.png" width="100%" >
              </li>
              <li>menu appear fill the form leave the fields which you don't want to enter. Click on save to save product</li>
              <li>
                <img src="images/fill_customer.png" width="100%" >
              </li>
              <li>Click on edit icon to made changes in customer info </li>
              <li>
                <img src="images/edit_customer.png" width="100%" >
              </li>
              <li style="background-color: red;">Click on trash icon to delete customer info (warning care fully)</li>
              <li>
                <img src="images/del_customer.png" width="100%" >
              </li>
