...
<html>
<head>
	<title><?php echo $row_b['Business_Name']; ?> Print Duplicate Invoice #:<?php echo $inv; ?></title>
		<style type="text/css">
			td,th{
				font-size: 15px;
			}
...
<body id="body">
	...
	<div align="center" style="border: 1px solid; width: 302px; margin: -5px auto;" id="main_wrapper">
					...
					<h4 style="border-top: 1px solid; border-bottom: 1px solid; background-color: black; color: white;">Duplicate Sales Invoice</h4>
						
					<p style="line-height: 0px; font-size: 15px; margin-top: -11px;">Inv.# : <?php echo $inv;?></p>
					...
					<div style="margin-top: -20px;">
						<h4 style="border-top: 1px solid; border-bottom: 1px solid; background-color: black; color: white;">Customer Information</h4>
						<p style="font-size: 15px; margin-top: -20px;"><b>Name: </b> <span><?php echo $sel_customer_row['Customer_Name']; ?></span></p>
		...
		<div>
			...
			<div style="border-top: 1px solid;">
				...
				<p style="font-size: 10px; margin-top: -16px; margin-bottom: 0px;">Designed & Developed by UTS Experts<br>Contact: 03437057036</p>
			</div>
		</div>
